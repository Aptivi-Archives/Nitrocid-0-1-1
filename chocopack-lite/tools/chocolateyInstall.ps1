...
$pkgName    = "kslite"
$url        = "https://github.com/Aptivi/NitrocidKS/releases/download/v0.1.1/0.1.1.0-bin-lite.zip"
$shacheck   = "ecc9b89e6b9af0162e7cfffba98acad0ef73759bec696f78c60579b940d7ba7c"
