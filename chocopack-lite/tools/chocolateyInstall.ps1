...
$pkgName    = "kslite"
$url        = "https://github.com/Aptivi/NitrocidKS/releases/download/v0.1.1.4/0.1.1.4-bin-lite.zip"
$shacheck   = "8467178662bff3d4f36bc61eb302220eb5fb5e09f0cf4992320d941c5122d37f"
