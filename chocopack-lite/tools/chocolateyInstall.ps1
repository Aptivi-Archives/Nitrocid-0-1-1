...
$pkgName    = "kslite"
$url        = "https://github.com/Aptivi/NitrocidKS/releases/download/v0.1.1.1/0.1.1.1-bin-lite.zip"
$shacheck   = "d4daf22f353fd835b261b8994f5df23eac31ed05504e20118899aeafc3252eca"
